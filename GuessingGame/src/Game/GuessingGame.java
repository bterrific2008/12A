...
public class GuessingGame {
	...
	public static void main(String[] args) {
		...
		// The actual game: Asks for name and ask for the guesses. Tells if you failed
		// or not
		...
		while (keepGoing) {
			...
			winning2 = ("Congratulations " + inputname + "! " + "You won in " + (i + 1) + " guess.");
			System.out.print("Your " + numGuess[i] + " guess: ");
			guess1 = (int) scnr.nextDouble();
			// kills the loop if you lost
			if (guess1 == randNum) {
				if (i != 0) {
					System.out.println(winning); //checks to see if there is one guess or two
				} else {
